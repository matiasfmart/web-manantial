    ...
    <>
      ...
      <section className="bg-white py-16 text-ink sm:py-20">
        <div className="section">
          <p className="eyebrow !text-brand">Programación</p>
          ...
          <div className="mt-8 overflow-hidden border border-ink/10">
            {radioSchedule.map((item, i) => (
              <div
                key={i}
                className="flex flex-wrap items-center justify-between gap-2 border-b border-ink/10 px-6 py-5 last:border-0 odd:bg-black/5"
              >
      ...
      <section className="section py-16 sm:py-20">
        {/* APPS */}
        <div id="apps" className="scroll-mt-24 border-y border-white/10 py-6 sm:py-8">
